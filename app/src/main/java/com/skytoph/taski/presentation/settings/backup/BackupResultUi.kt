...
import com.skytoph.taski.presentation.core.MapResultToListOfEvents
import com.skytoph.taski.presentation.settings.backup.BackupMessages.clearingDataFailedMessage
import com.skytoph.taski.presentation.settings.backup.BackupMessages.clearingDataSucceededMessage
import com.skytoph.taski.presentation.settings.backup.BackupMessages.createBackupSucceededMessage
import com.skytoph.taski.presentation.settings.backup.BackupMessages.deletingAccountFailedMessage
import com.skytoph.taski.presentation.settings.backup.BackupMessages.deletingAccountSucceededMessage
import com.skytoph.taski.presentation.settings.backup.BackupMessages.exportFailedMessage
import com.skytoph.taski.presentation.settings.backup.BackupMessages.iconsSynchronizeErrorMessage
import com.skytoph.taski.presentation.settings.backup.BackupMessages.iconsSynchronizeSuccessMessage
import com.skytoph.taski.presentation.settings.backup.BackupMessages.importFailedMessage
import com.skytoph.taski.presentation.settings.backup.BackupMessages.importSucceededMessage
import com.skytoph.taski.presentation.settings.backup.BackupMessages.signInFailedMessage
import com.skytoph.taski.presentation.settings.backup.BackupMessages.signOutFailedMessage
import com.skytoph.taski.presentation.settings.backup.BackupMessages.syncFailedMessage
