...
fun Habit.toHabitDB() = HabitEntity(id, title, goal, iconName, color, priority, isArchived)

fun HabitEntity.toHabit() = Habit(id, title, goal, iconName, color, priority, isArchived)