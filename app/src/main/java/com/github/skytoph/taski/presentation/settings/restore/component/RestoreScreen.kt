...
import com.github.skytoph.taski.presentation.settings.restore.RestoreViewModel
...
fun RestoreScreen(viewModel: RestoreViewModel = hiltViewModel()) {
    ...
    val actionDeleteData = remember {
        AppBarAction(
            ...
            icon = com.github.skytoph.taski.presentation.core.state.IconResource.Id(R.drawable.trash),
            color = error,
