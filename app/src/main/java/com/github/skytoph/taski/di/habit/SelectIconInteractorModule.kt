...
object SelectIconInteractorModule {
    ...
    @Provides
    fun interactor(datastore: IconsDatastore, networkManager: NetworkManager, drive: BackupDatastore): IconsInteractor =
        IconsInteractor.Base(datastore, networkManager, drive)
